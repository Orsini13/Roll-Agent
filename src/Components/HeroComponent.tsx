...
const HeroComponent = () => {
    return (
        <div className="m-auto items-center flex flex-row relative ">
            ...
            <div className="text-center absolute z-999 items-center flex flex-col space-y-14 p-20 ">
                ...
                <h2 className="font-400 leading-3">
                    ...
                    <Link to="/Home">
                        <button className="text-blue-600 flex flex-row bg-white space-x-1 p-2 border border-solid border-blue-700 rounded-lg " >
                            <h1>Get Started</h1>
